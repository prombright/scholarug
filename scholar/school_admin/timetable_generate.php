...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['generate'])) {
    $result = admin_timetable_generate_run($pdo, $school_id, $term, $year);
    $overview = admin_timetable_generate_overview($pdo, $school_id);
}

$periodCount = $overview['period_count'];
$assignmentCount = $overview['assignment_count'];
$hasExisting = $overview['has_existing'];
